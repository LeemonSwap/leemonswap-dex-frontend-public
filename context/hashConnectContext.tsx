...
const appMetadata: HashConnectTypes.AppMetadata = {
  name: "LeemonSwap",
  description: "LeemonSwap: Hedera's most advanced DEX",
...
export const useHashconnectService = () => {
  ...
  const { topic, pairingData, network, setState, state } = value;
  ...
  const isPaired = () => state === HashConnectConnectionState.Paired;
